...
*/
	void EndBuild()
	{
		...
		for(;;)
		{
			...
			buffer.setElement(Tile.traderPost(), StairX, StairY);//MainGame.csi.print(StairX , StairY, "/");
			traderPost = new IntPoint(StairX + 1, StairY + 1);
			break;
		}
	}
